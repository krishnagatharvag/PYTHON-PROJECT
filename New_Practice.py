...
#fibonacci series
#create a new list having no duplicate(no repetation) value from two list
...
#reverse the string with string variable
...
# input d1 outpuc2b3a4t aaaabbbcca(shorted order)
#input aaaabbbccd outpot a4b3c2a1
# extract word starting letter with k in s string/list
